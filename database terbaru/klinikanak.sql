...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 27, 2018 at 05:04 AM
...
(7, 'fira', '1998-10-10', 123321, 897865432, 'syafira@gmail.com', 'yk', 'Female', 'firaa', '5ebe2294ecd0e0f08eab7690d2a6ee69', '2018-11-27 10:56:01');
...
INSERT INTO `dokter` (`id_dokter`, `nama_dokter`, `nip`, `tgl_lahir`, `no_hp`, `email`, `alamat`, `gender`, `username`, `password`, `daftar`, `id_pasien`) VALUES
(1, 'Sinta Tantular Maharaja', 12345678, '1980-11-01', 98765431, 'sinta@gmail.com', 'Yogyakarta', 'Female', 'sinta2', '08ca451b5ef1a7c86763d31e7711a522', '2018-11-25 10:14:00', 0),
(5, 'Dadat Manila', 9875, '1980-11-01', 468976, 'dadat@gmail.com', 'Yogyakarta', 'Male', 'dadat', '0f6e2d24c06a69acf0a68c3ece783ac0', '2018-11-25 12:09:52', 0),
(6, 'Risang', 98765, '1980-01-01', 98765412, 'risang@gmail.com', 'jogja', 'Male', 'risang', '5ebe2294ecd0e0f08eab7690d2a6ee69', '2018-11-27 08:59:18', 0);
...
(12, 1, '08.00-08.15 WIB', 'Booked'),
(13, 2, '08.15-08.30 WIB', ''),
(14, 3, '08.30-08.45 WIB', '');
...
(2147483647, 'Gaksa Gantara', '1999-01-01', 'Male', 'Ibu Pertiwi', 81234321, 'g.gantara7@gmail.com', 'jogja', 'g.gantara', '5ebe2294ecd0e0f08eab7690d2a6ee69', '', 0, '2018-11-27 08:37:58');
...
--
ALTER TABLE `apoteker`
  MODIFY `id_apoteker` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `dokter`
--
ALTER TABLE `dokter`
  MODIFY `id_dokter` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
