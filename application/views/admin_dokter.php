    ...
    <section class="content">
      ...
      <!-- Button Daftar PUI -->
        ...
        <div class="col-lg-2 col-xs-6">
          <a href="<?php echo base_url('cAdmin/exportDokter'); ?>">
                ...
                <tbody>
                  <?php
                    ...
                    <tr>
                      ...
                      <td>
                         <div class="btn-group">
                        <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal-<?php echo $row->id_dokter; ?>" >Change</button>
                        </div>
                      </td>
                      
                      <td>
                      
                         <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModalDetail<?php echo $row->id_dokter?>"><i class="glyphicon glyphicon-eye-open"></i></button>
                      
                         
                          <button type="button" class="btn btn-warning"  data-toggle="modal" data-target="#myModal<?php echo $row->id_dokter?>"><i class="glyphicon glyphicon-pencil"></i></button>
                          <div class="btn-group">  

                         <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#hapus<?php echo $row->id_dokter?>"><i class="glyphicon glyphicon-trash"></i></button>
                          </div>
                      </td>
                    </tr>
                    <?php
...
<!--modal change pass user-->
 <?php
      foreach ($dokter->result() as $row) {
  ?>
  <div class="modal modal-default fade" id="modal-<?php echo $row->id_dokter; ?>" >
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form method="post" action="<?=base_url()?>cAdmin/ubahKataSandiDokter" data-toggle="validator">
              <input type="hidden" name="username" value="<?php echo $row->username?>">
              <input type="hidden" name="id_dokter" value="<?php echo $row->id_dokter?>">
                    <center><p>Are you sure to change password from Doctor <?php echo $row->nama_dokter?></p></center>
...
<!--modal add -->
   <div class="modal fade" id="modal-add">
    <form method="post" action="<?php echo base_url('cAdmin/addDokter')?>" enctype="multipart/form-data">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
     ...
     <div class="modal fade" id="modal-default">
      ...
      <?php
        foreach ($dokter->result() as $row) {
      ?>
        <div class="modal fade" id="myModalDetail<?php echo $row->id_dokter?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <center><h4 class="modal-title" id="myModalLabel">Detail Data Doctor <?php echo $row->nama_dokter;?></h4></center>
              </div>
              <div class="modal-body">
                <div class="col-xs-12">
                <div class="box">
      ...
      <?php
        foreach ($dokter->result() as $row) {
      ?>
        <div class="modal fade" id="hapus<?php echo $row->id_dokter?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              ...
              <div class="modal-body">
                  <form method="post" action="<?=base_url()?>cAdmin/hapusDokter" data-toggle="validator">
                    <input type="hidden" name="id_dokter" value="<?php echo $row->id_dokter?>">
                    <center><p>Are you sure delete data Doctor <?php echo $row->nama_dokter;?> ?</p></center>
                    <div class="modal-footer">
      ...
      ?>
        ...
        <div class="modal fade" id="myModal<?php echo $row->id_dokter?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <center><h4 class="modal-title" id="myModalLabel">Change Data Doctor <?php echo $row->nama_dokter;?></h4></center>
              </div>
              <div class="modal-body">
                <form method="post" action="<?=base_url()?>cAdmin/ubahDataDokter" data-toggle="validator">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $row->nama_dokter?>" name="nama_dokter" placeholder="Name" required>
                    </div>
                  </div><!-- /.form-group -->
                  <div class="form-group">
