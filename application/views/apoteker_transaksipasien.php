    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Transactions Pasien</li>
        </ol>
      </section>
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="btn-group"> 
                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modalview">Accepted</i></button>
                        </div>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="no_urut" disabled="disabled" value="">
                    </div>
                </div>
                <div class="form-group">
                    <label>KK :</label>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="obat" disabled="disabled" value="">
                    </div>
                </div>
