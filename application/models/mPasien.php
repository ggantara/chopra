<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class mPasien extends CI_Model {
    	...
    	public function get_data_bookingpasien(){
    ...
    //change pass user
  public function ubahSandi($id_pasien,$newpass){
      $this->db->query("update pasien set password=md5('$newpass') where id_pasien='$id_pasien'");
    }
