...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2018 at 01:06 PM
...
CREATE TABLE `periksa` (
  ...
  `id_apoteker` int(255) NOT NULL,
  `id_obat` int(255) NOT NULL,
  `status_resepselesai` int(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `periksa`
  ADD CONSTRAINT `periksa_ibfk_1` FOREIGN KEY (`id_pasien`) REFERENCES `pasien` (`id_pasien`),
  ADD CONSTRAINT `periksa_ibfk_2` FOREIGN KEY (`id_dokter`) REFERENCES `dokter` (`id_dokter`),
  ADD CONSTRAINT `periksa_ibfk_4` FOREIGN KEY (`id_apoteker`) REFERENCES `apoteker` (`id_apoteker`),
  ADD CONSTRAINT `periksa_ibfk_5` FOREIGN KEY (`id_obat`) REFERENCES `obat` (`id_obat`);
COMMIT;
